...
class SingleQuestionContainerHistoryUseCase
    implements
        BaseUseCase<SubmitSingleQuestionRequest, SingleQuestionHistoryModel> {
  final Repository _repository;

  SingleQuestionContainerHistoryUseCase(this._repository);
  ...
  Future<Either<Failure, SingleQuestionHistoryModel>> execute(
    ...
    return _repository
        .submitSingleContainerQuestionHistory(submitSingleQuestionRequest);
  }
}
