...
import 'package:gamification/presentation/map/view/map_library/helper/utils.dart';
...
class _GameLevelsScrollingMapState extends State<GameLevelsScrollingMap> {
  ...
  Future _getPathFromSVG() async {
    await getPointsPathFromXML().then((value) {
      ...
      // List<int> arrayOfDeletedPoints = [1,3,5,7,9,11,13,15,16,18,21,23,25,27,28,29,30,31,33,35,36,38,40,41,43,44,46,48,51,52,54,56,58,60,62,63,66,68,69,70,71,73,75,77,79];
